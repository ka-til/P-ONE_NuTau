...
script=/home/users/akatil/P-ONE/git/PONE_NuTau/NuTau_Simulation/step_5_makeRecoPulses.py
...
OUTNAME=step_5_${RUNNUM}_medium_water_custom_mDOM_recoPulse.i3.gz
OUTDIR=/data/p-one/akatil/step_5_medium_water/NuTau_NuE_20Events
