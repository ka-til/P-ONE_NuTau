...
for i in range(0,20):
    for j in range(0, 1):
        #if i == 37 or i == 21 or i == 51 or i == 24 or i == 49:
            #continue
    ...
    #infile = '/data/p-one/akatil/timeResiduals/generatePhotons_' + str(i) + '_2_right.i3.gz'
        infile = '/data/p-one/akatil/timeResiduals/Wavelength_20200326/WAVELENS/genPhotons_' + str(i) + '_3_1000000Loop_2e5_spread_blue.i3.gz'
        print (i)
        #infile = '/home/users/akatil/P-ONE/medium/SCPhotonsSTRAW.i3'
        tRes1, tRes2, tRes3, W1, W2, W3, wlen = timeRes(infile,465)
...
np.savetxt('/home/users/akatil/P-ONE/tResiduals/blueDOM_0_54_1000000_2e5_spreadDFDW6_AvgAngleCos_STRAWGeo.csv', timeResidsBlue1, delimiter=',')
np.savetxt('/home/users/akatil/P-ONE/tResiduals/blueDOM_0_70_1000000_2e5_spreadDFDW6_AvgAngleCos_STRAWGeo.csv', timeResidsBlue2, delimiter=',')
np.savetxt('/home/users/akatil/P-ONE/tResiduals/blueDOM_0_88_1000000_2e5_spreadDFDW6_AvgAngleCos_STRAWGeo.csv', timeResidsBlue3, delimiter=',')
