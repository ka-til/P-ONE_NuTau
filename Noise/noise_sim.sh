...
script=/home/users/akatil/P-ONE/git/PONE_NuTau/Noise/SimNoise.py
echo "Will use script: " $script

RUNNUM=$1

GCDFILE=/home/users/akatil/P-ONE/GCD_files/PONE_Phase1.i3.gz
INNAME=step_3_${RUNNUM}_medium_water_custom_mDOM_katil.i3.gz
INDIR=/data/p-one/akatil/step_3_medium_water/Custom
OUTNAME=step_4_${RUNNUM}_medium_water_custom_mDOM_noise.i3.gz
OUTDIR=/data/p-one/akatil/step_4_medium_water/
