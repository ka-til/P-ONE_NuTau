import sys
sys.path.insert(0,'/home/users/dhilu/P_ONE_dvirhilu/src/experimentModelCode')
...
filePath = '/home/users/akatil/P-ONE/git/PONE_NuTau/DOM/IceCube/'
...
domAcceptance = GetIceCubeDOMAcceptance(domRadius = DOMOversizeFactor*DOMRadius)
