...
def likelihoodfit(frame, omgeo, file_num, frame_num, csv_writer):
    ...
    for omkey in recoPulseMap.keys():
        ...
        #removid bins with < 10 entries ---> To maintain the poisson distribution?
        entries_in_bins = num[num > 10]
        bin_centers = bin_centers[num > 10]
        ...
        info_list = [file_num, frame_num, lepton.type, omkey[0], omkey[1], mean_entries, success_biGauss, success_doublePeak,
        ...
        csv_writer.writerow({'file': info_list[0], 'frame': info_list[1], 'lepton_type': info_list[2], 'DOM': info_list[3], 'string': info_list[4],
                            ...
                            'gof_biGauss': info_list[23], 'gof_doublePeak': info_list[24]})
